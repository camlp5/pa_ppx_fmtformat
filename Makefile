...
META: sys
	$(JOINMETA) -rewrite pa_ppx_fmtformat_runtime:pa_ppx_fmtformat.runtime \
			-direct-include pa_fmtformat \
			-wrap-subdir runtime:runtime > META

install: META
	$(OCAMLFIND) remove pa_ppx_fmtformat || true
	$(OCAMLFIND) install pa_ppx_fmtformat META local-install/lib/*/*.*
